...
<body>
    <header>
        ...
        <h3><em>Celebrating our <span class="shadow">75<sup>th</sup></span> Year</em></h3>
    </header>
    <main>
        <section>
            ...
            <h2 class="section-title">Our Ticket Packages</h2>
            <ul>
        ...
        <section>
            ...
            <img src="images/brancaccio.jpg" alt="David Brancaccio photo">
            <h3>November<br><a href="#">Andrew Ross Sorkin</a></h3>
            <img src="images/sorkin.jpg" alt="Andrew Ross Sorkin photo">
            <h3>January<br><a href="#">Amy Chua</a></h3>
            <img src="images/chua.jpg" alt="Amy Chua photo">
            <div class="section-line"></div>
        </section>
    </main>
    <footer>
